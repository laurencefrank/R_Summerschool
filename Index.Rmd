...
install.packages(c("tidyverse", "knitr", "rmarkdown", "rmdformats", "prettydoc", 
                   ...
                   "kableExtra", "GGally"), dependencies = TRUE)
```
...
1.  You will receive an account to Utrecht University's
    [Solisworkspace](https://solisworkspace.uu.nl/). You would have access to
...
* [R Studio Cheatsheet](https://rstudio.github.io/cheatsheets/rstudio-ide.pdf)

Introduction to R Markdown:

* [What is R Markdown? Quick introduction to R Markdown](https://rstudio.github.io/cheatsheets/html/rmarkdown.html#what-is-rmarkdown)
...
- Create an R Project
  - [Intro to R Projects](Day1/0_IntroRProjects.html)
    
- Part 1a. Introduction to R and RStudio
  - [Lecture 1a](Day1/1a_lecture.html)
  - [Lab 1a](Day1/1a_lab.html)

- Part 1b. R Basics: packages, functions, getting help
  - [Lecture 1b](Day1/1b_lecture.html)
  - [Lab 1b template](Day1/1b_lab_template.Rmd)
  - [Lab 1b answers](Day1/1b_lab.html)
    
- Part 1c. Data objects
  - [Lecture 1c](Day1/1c_lecture.html)
  - [Lab 1c template](Day1/1c_lab_template.Rmd)
  - [Lab 1c answers](Day1/1c_lab.html)

- Part 1d. Operators
  - [Lecture 1d](Day1/1d_lecture.html)
  - [Lab 1d template](Day1/1d_lab_template.Rmd)
  - [Lab 1d answers](Day1/1d_lab.html)
...
- Part 2a. Data manipulation: tidyverse, importing data
  - [Lecture 2a](Day2/2a_lecture.html)
  - [Lab 2a template](Day2/2a_lab_template.Rmd)
  - [Lab 2a answers](Day2/2a_lab.html)

- Part 2b. Data visualisation
  - [Lecture 2b](Day2/2b_lecture.html)
  - [Lab 2b template](Day2/2b_lab_template.Rmd)
  - [Lab 2b answers](Day2/2b_lab.html)
...
-   *Foundations of Statistics with R*
    ...
    -   [12-12.0.1: Multiple regression](https://bookdown.org/speegled/foundations-of-statistics/multiple-regression.html){target="_blank"}
...
- Part 3a. Linear model
  - [Lecture 3a](Day3/3a_lecture.html)
  - [Lab 3a template](Day3/3a_lab_template.Rmd)
  - [Lab 3a answers](Day3/3a_lab.html)

- Part 3b. Diagnostics
  - [Lecture 3b](Day3/3b_lecture.html)
  - [Lab 3b template](Day3/3b_lab_template.Rmd)
  - [Lab 3b answers](Day3/3b_lab.html)
...
- Part 4a. Programming
  - [Lecture 4a](Day4/4a_lecture.html)
  - [Lab 4a template](Day4/4a_lab_template.Rmd)
  - [Lab 4a answers](Day4/4a_lab.html)

- Part 4b. Statistical inference, bootstrap
  - [Lecture 4b](Day4/4b_lecture.html)
  - [Lab 4b template](Day4/4b_lab_template.Rmd)
  - [Lab 4b answers](Day4/4b_lab.html)
...
- Lecture
  - [Lecture 5](Day5/Lecture/Communicating_Results.html)

- Assignment
  - [Assignment document](Day5/Assignment/Assignment_Data_Analysis_Cycle.html)
  
- Data sets
The assignment document above contains links to data sets. 6_Self_study
Here you find 2 additional data sets:
  - [Mammals sleep data](Day5/data_sets/MammalsSleepData.RData)
  - [Penguins data](Day5/data_sets/Penguins.RData)
  
- Example data analysis workflow
  - [RMarkdown document data analysis workflow](Day5/Example_Data_Analysis_Cycle/ExampleWorkflow.Rmd)
  
- Presentations with RMarkdown
  - [RMarkdown presentation template](Day5/RMarkdown_presentation_template/Ioslides_tempate.Rmd)
  - [Custom stylefile for RMarkdown presentations](Day5/RMarkdown_presentation_template/custom.css)
...
### **Responsible use of AI for coding in R**

Here is an [exercise](6_Self_study/GenAI/R_Boxplot_exercise.html) that will teach you how to use an AI tool to assist you with writing code in R using the BRAVE(R) framework (Fox & Boelen, *GSLS GenAI Teacher Tutorial*, Chapter 3, CC BY-SA-NC 4.0.) framework. This [BRAVE(R) framework](https://zenodo.org/records/14507109) promotes human oversight and supports effective prompting. 
...
[Lab part 1](6_Self_study/ShinyApps/Lab_Shiny_Part1.html)

Make a more advanced Shiny app:

[Lab part 2](6_Self_study/ShinyApps/Lab_Shiny_Part2.html)

Answers Lab part 2:

[server.R](6_Self_study/ShinyApps/server.R)

[ui.R](6_Self_study/ShinyApps/ui.R)
